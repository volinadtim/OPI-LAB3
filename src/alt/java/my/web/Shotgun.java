...
public class Shotgun {
    ...
    public Shotgun() {
        shots = orm.getCracks(getShooter());
    }
    ...
    public void shoot() {
        ...
        var shot = createCrack();
        shots.add(shot);
        orm.createCrack(shot);
        shots = orm.getCracks(getShooter());
    }
    ...
    private Crack createCrack() {
        ...
        return new Crack(coordinateX, coordinateY, radius, hit, now, elapsedTime, shooter);
    }
