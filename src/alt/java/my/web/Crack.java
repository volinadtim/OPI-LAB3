...
public class Crack implements Serializable {
    ...
    public Crack(float x, float y, float radius, boolean hit, Date date, long executionTime, String shooter) {
        this.x = x;
        this.y = y;
        this.radius = radius;
        this.hit = hit;
    ...
    public Crack(int id, float x, float y, float radius, boolean hit, Date date, long executionTime, String shooter) {
        this.id = id;
        this.x = x;
        this.y = y;
        this.radius = radius;
    ...
    public String toString() {
        return "Crack[" + "x=" + x + ", " + "y=" + y + ", " + "radius=" + radius + ", " + "hit=" + hit + ", " + "date=" + date + ", " + "executionTime=" + executionTime + ']';
    }
}
